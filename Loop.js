...
// /////////NESTED FOR LOOP
// // for (let i=1 ; i<=10;i++){
// //     console.log(`I IS OUTER LOOP:${i}`);
// //     for (let j =1;j<=3;j++){
// //         console.log(`j Is INNER LOOP:${j}`);
// //     }
// // }
// const NIT_student=[
//     {
...
//     }
//   ]
//   for (let i=0 ; i<NIT_student.length;i++){
//     const data = NIT_student[i]
//     console.log(`ROW #:${i+1}`);
...
// const secret = "Ayush"
// let guess= prompt("Enter the screat code to unclock...")
// while (guess!==secret){
//     guess = prompt("please enter correct password ..")
// }
// console.log("Congratulation You have sucessfully uncloced It");
